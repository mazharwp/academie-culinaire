<?php
/*
Template Name: USA & Canada Delegation
*/
get_header();
                                ...
                                <?php if (have_rows('button_link')): ?>
                                    <?php while (have_rows('button_link')): the_row(); ?>
                                        <div class="custom-btn-2">
                                            <a href="<?php the_sub_field('button_url1'); ?>" target="_blank">
                                                <button class="btnDefault">
                                                    <span><?php the_sub_field('button_title1'); ?></span>
                                                    <span class="ps-2">
                                                        ...
                                                        <img loading="lazy" alt="image" src="<?php echo get_template_directory_uri(); ?>/assets/img/right-arrow.svg" class="right-arrow change-img2">
                                                    </span>
                                                </button>
                                            </a>
                                        </div>
