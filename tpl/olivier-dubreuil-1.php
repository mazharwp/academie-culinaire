<?php
/*
Template Name: OLIVIER DUBREUIL 1
*/
get_header();
...
<section class="logo-marquee racesWrapper francois-marquee">
    ...
    <section class="francois-chef-sec">
        <div class="container-fluid">
            ...
            <div class="francois-servings-table">
                ...
                <ul> <?php the_field('description3'); ?></ul>
                ...
                <ul> <?php the_field('decription4'); ?> </ul>
				...
				<div class="table-responsive">
                  <table class="table table-hover">
                    <h3><?php the_field('title8'); ?></h3>
                   <?php the_field('table3'); ?>
                    </table>
                </div>

                <ul><?php the_field('description19'); ?></ul>


                <div class="table-responsive">
                  <table class="table table-hover">
                    <h3><?php the_field('title9'); ?></h3>
                   <?php the_field('table4'); ?>
                    </table> 
                </div>

                <ul><?php the_field('description18'); ?></ul>

            <div class="table-responsive">
                 <table class="table table-hover">
                 <h3><?php the_field('title10'); ?></h3>
                <?php the_field('table5'); ?>
                 </table>     
             </div>

             <ul><?php the_field('description17'); ?></ul>
             


             <div class="table-responsive">
                 <table class="table table-hover">
                 <h3><?php the_field('title11'); ?></h3>
             ...
             <div class="table-responsive">
                 <table class="table table-hover">
                 <h3><?php the_field('title13'); ?></h3>
                <?php the_field('table8'); ?>
                 </table>
                 
             </div>

             <ul><?php the_field('description16'); ?></ul>
...
<section class="slider-reciepe mb-50">
    <div class="row">
        <?php require 'slider-reciepe.php'; ?>
    </div>
</section>
