<?php
/*
Template Name: SEBASTIEN BAUD 2
*/
get_header();
    ...
    <section class="francois-chef-sec">
        <div class="container-fluid">
            ...
            <div class="francois-servings-table">
                ...
                <ul><?php the_field('short_description3'); ?></ul>
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                       ...
                       <?php the_field('description6'); ?>
                    </table>
                    
                </div>
                <ul><?php the_field('short_description6'); ?></ul>

                <div class="table-responsive">
                    <table class="table table-hover">
                        <h3><?php the_field('title7'); ?></h3>
                       <?php the_field('description7'); ?>
                    </table>
                    
                </div>
                <ul><?php the_field('short_description7'); ?></ul>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 d-flex align-items-center">
                        <div class="francois-social-text">
                            <h6> <?php the_field('share_title'); ?></h6>
