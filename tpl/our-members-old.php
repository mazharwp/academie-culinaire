                    ...
                    <div class="tab-pane fade" id="canadaMembers" role="tabpanel" aria-labelledby="canadaMembers-tab"
                        ...
                        <section class="member-chefs">
                            <div class="container">
                                ...
                                <?php endwhile; ?>
                                <?php endif; ?>
                                <?php if( have_rows('member_chefs_canada', 'option') ): ?>
                                  
                                <?php while( have_rows('member_chefs_canada', 'option') ): the_row(); ?>
                                ...
                                <div class="boardMember" id="<?php echo strtolower(str_replace(" ","_",get_sub_field('canada_state'))); ?>">
                                    ...
                                    <div class="chefs-main">
                                        <div class="row">
                                            <?php if( have_rows('canada_member_chefs', 'option') ): ?>
                                            <?php while( have_rows('canada_member_chefs', 'option') ): the_row(); ?>
                                            <div class="col-lg-6">
                                                <div class="member-chef-box">
                                                    <div class="card  light-red">
                                                        <div class="row g-0">
                            ...
                            <div class="container">
                                ...
                                <div class="chefs-main">
                                    <div class="row">
                                        ...
                                        <?php endwhile; ?>
                                        <?php endif; ?>
                                         <?php if( have_rows('member_chefs_retired', 'option') ): ?>
                                        <?php while( have_rows('member_chefs_retired', 'option') ): the_row(); ?>
                                        <?php if( have_rows('retired_member_chefs', 'option') ): ?>
                                        <?php while( have_rows('retired_member_chefs', 'option') ): the_row(); ?>
                                        <div class="col-lg-6">
                                            <div class="member-chef-box">
                                                <div class="card light-red">
                                                    <div class="row g-0">
