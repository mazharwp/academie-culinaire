<?php
/*
Template Name: FR MEMBER RESERVATION
*/
get_header();
...
#forminator-module-1707 {
    border-style: none !important;}

.forminator-pagination-footer {
    padding: 0 50px 0 50px;
}
.forminator-ui#forminator-module-24158.forminator-design--default .forminator-button-next {
    width: 100% !important;}
.forminator-pagination-footer {
    width: 100%;
}
