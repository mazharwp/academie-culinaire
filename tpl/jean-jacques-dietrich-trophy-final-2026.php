<?php
/*
Template Name: Jean-Jacques Dietrich Trophy / Final 2026
*/
get_header();
 ...
 <section class="the-jean-chef-sec trophy-roland-sec-container">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight2" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body">
                 <h5><?php the_field('contact111'); ?></h5>
                <p><?php the_field('description111'); ?></p>
            <div class="registration-form">

                <?php the_field('right_shortcode'); ?>
                <!--<p>Please check your Junk folder as our file may be there. We apologize for any inconvenience.</p> -->
          ...
          <div class="competition-contact-logo">
            ...
            <h6><?php the_field('address111'); ?></h6>
            ...
            <section div class="the-jean-competition-btn trophy-roland-competition-btn">
                    ...
                    <div class="competition-contact-form">
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight1" aria-labelledby="offcanvasRightLabel">
                            ...
                            <div class="offcanvas-body">
                                <h5><?php the_field('contact1111'); ?></h5>
                                <p><?php the_field('description1111'); ?></p>
                                <div class="registration-form">
                              ...
                              <div class="competition-contact-logo">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo_conatact.png" alt="logo" class="img-fluid">
                                    <h6><?php the_field('address1111'); ?></h6>
                                    <p><?php the_field('address_description1'); ?></p>
                              </div>
