        ...
        <div class="container-fluid">
            ...
            <div class="francois-servings-table">
                ...
                <div class="francois-servings-list">
                    <h6><?php the_field('title4'); ?></h6>
                    <ul>
                    <?php the_field('decription4'); ?>
                    </ul>
            ...
            <div class="col-lg-12">
              <div class="donate-main text-center">
                <div class="donate-content text-center mobile-view donateBox-here">
                 <h2><?php the_field('donate_name'); ?></h2>
                 <h5><?php the_field('donate_title'); ?></h5>
                  <p><?php the_field('donate_description'); ?></p>
                  <div class="custom-btn-2">
                     <a href="<?php the_field('donate_button_link'); ?>">
                        <button class="btnDefault"> <span><?php the_field('donate_button'); ?></span>
                            <span class="ps-2">
                            ...
                            <img loading="lazy" alt="Donate" src="<?php echo get_template_directory_uri(); ?>/assets/img/right-arrow.svg" class="right-arrow change-img2"></span>
                        </button>
                    </a>
                  </div>
                </div>
...
<?php require 'tpl/botton-news.php'; ?>
